...
import { NIDVerificationDialog } from "./NIDVerificationDialog";
...
export function VotingDashboard({ voterName, isPostal = false }: VotingDashboardProps) {
  ...
  const handleVerificationComplete = async (data: { nidFront: string; nidBack: string; face: string }) => {
    ...
    try {
      ...
      if (result.overall_verified && selectedCandidate) {
        setVerificationStatus('verified');
        setVotedCandidateId(selectedCandidate.id);
        // Here you would also call blockchain API to record the vote
      } else {
        ...
        {verificationStatus === 'verifying' && (
          <Alert className="bg-yellow-50 border-yellow-500">
            ...
            <AlertDescription className="text-yellow-800">
              <strong>আপনার পরিচয় যাচাই করা হচ্ছে...</strong> অনুগ্রহ করে অপেক্ষা করুন।
            </AlertDescription>
          </Alert>
        )}
        
        {verificationStatus === 'verified' && votedCandidateId && (
        ...
        {verificationStatus === 'failed' && (
          <Alert className="bg-red-50 border-red-500">
            ...
            <AlertDescription className="text-red-800">
              <strong>আপনার পরিচয় যাচাই করা যায়নি।</strong> আবার চেষ্টা করুন।
            </AlertDescription>
          </Alert>
        )}
        
        {verificationStatus === 'idle' && !votedCandidateId && (
          <Alert>
